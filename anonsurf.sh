...
# along with Foxxy Security OS. If not, see <http://www.gnu.org/licenses/>.
...
function ip {
	...
	MYIP=`wget -qO- https://start.foxxysec.org/ip/`
	echo -e "\nMy ip is:\n"
	echo $MYIP
	echo -e "\n"
	notify "My IP is:\n\n$MYIP"
...
function start {
	...
	echo -e " $GREEN*$BLUE Modified resolv.conf to use Tor and FoxxyDNS\n"
